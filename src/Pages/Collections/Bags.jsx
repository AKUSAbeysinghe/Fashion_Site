...
// import LinenJacket from '../../assets/Clothing/BG6.jpeg';
// import SuedeJacket from '../../assets/Clothing/BG7.jpeg';
// import SuedeJacketModel from '../../assets/Clothing/BG8.jpeg';
...
// import w9 from "../../assets/Clothing/bags2.jpg";
// import w10 from "../../assets/Clothing/bags3.jpg";
// import w11 from "../../assets/Clothing/bags4.jpg";

// import w12 from "../../assets/Clothing/bags5.jpg";
// import w13 from "../../assets/Clothing/bags6.jpg";
// // import w14 from "../../assets/Clothing/Bag.jpeg";
// // import w15 from "../../assets/Clothing/Acc32.jpeg";
...
//       try {
//         // Fetch bags for both men and women
//         const response = await fetch('http://localhost/react_admin_db/get_products.php?category=bags');
//         const data = await response.json();
//         if (Array.isArray(data)) {
//           // Map the fetched data to match ProductCard's expected structure
//           const formattedProducts = data.map((item) => ({
//             id: item.id,
//             imageUrl: item.image_url,
//             name: item.name,
//             price: Number(item.price).toFixed(2), // Format price as string with 2 decimals
//             collection: item.collection.toUpperCase(), // Match original uppercase collection
//           }));
...
const CombinedHomepage = () => {
  ...
  const fallbackLookbooks = [
    { id: 1, image_url: LookBook1, collection: "Bags", gender: "Unisex" },
    { id: 2, image_url: LookBook2, collection: "Bags", gender: "Unisex" },
    { id: 3, image_url: LookBook3, collection: "Bags", gender: "Unisex" },
    { id: 4, image_url: LookBook4, collection: "Bags", gender: "Unisex" },
    { id: 5, image_url: LookBook5, collection: "Bags", gender: "Unisex" },
  ];
  ...
  useEffect(() => {
    ...
    const fetchProducts = async () => {
      try {
        ...
        console.error('Error fetching products(Varun):', error);
        setError('Error fetching products.');
      }
    };

    // Fetch bags lookbooks
    const fetchLookbooks = async () => {
      try {
        const response = await fetch('http://localhost/react_admin_db/get_lookbook.php?collection=bags');
        const data = await response.json();
