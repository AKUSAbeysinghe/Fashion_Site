...
import LinenJacket from '../assets/Clothing/Men1.jpeg';
import SuedeJacket from '../assets/Clothing/Men2.jpeg';
import SuedeJacketModel from '../assets/Clothing/Men3.jpeg';
import PleatedJacket from '../assets/Clothing/Men4.jpeg';
import LeatherJacket1 from '../assets/Clothing/Men5.jpeg';
import BgImage from '../assets/Background/Flower.jpeg'; // Your background image for left/right/bottom
...
const Header = () => {
  return (
    ...
    <header className="flex justify-between items-center py-4 px-6 border-b border-gray-200 z-20 relative bg-white">
...
const App = () => {
  ...
  return (
    <section className="relative min-h-screen bg-white">
      {/* Left BG */}
      <div
        className="fixed top-0 left-0 w-[2%] h-full bg-cover bg-center"
        style={{ backgroundImage: `url(${BgImage})` }}
      />
      {/* Right BG */}
      <div
        className="fixed top-0 right-0 w-[2%] h-full bg-cover bg-center"
        style={{ backgroundImage: `url(${BgImage})` }}
      />
      {/* Bottom BG */}
      <div
        className="fixed bottom-0 left-[2%] w-[96%] h-[2%] bg-cover bg-center"
        style={{ backgroundImage: `url(${BgImage})` }}
      />

      <div className="relative z-10 w-[100%] mx-auto flex flex-col min-h-screen">
        <Header />
        <main className="flex-grow">
          <div className="flex justify-end p-4 pr-6">
            <div className="flex space-x-4 text-sm">
              {/* <button className="font-medium text-gray-700 hover:text-gray-900 focus:outline-none">VIEW</button>
              <button className="font-medium text-gray-700 hover:text-gray-900 focus:outline-none">FILTERS</button> */}
            </div>
          </div>
